...
# ============================
# 1. Define the Siamese Network
# ============================
class SiameseNetwork(nn.Module):
    def __init__(self):
        super(SiameseNetwork, self).__init__()
        vgg16 = models.vgg16(weights=models.VGG16_Weights.IMAGENET1K_V1)  # Updated
        
        self.feature_extractor = vgg16.features
        self.flatten = nn.Flatten()  # Updated
    ...
    def forward(self, x1, x2):
        ...
        f1 = self.flatten(f1).view(f1.size(0), -1)
        f2 = self.flatten(f2).view(f2.size(0), -1)

        f1, f2 = self.fc(f1), self.fc(f2)
        return f1, f2
...
class SiameseDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return img1, img2, torch.tensor(label, dtype=torch.long)  # Updated
...
def main(dataset_path):
    ...
    # ============================
    base_dir = "/l/users/zainab.aldhanhani/CV703Project/Dataset"
